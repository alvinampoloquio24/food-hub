...
export default function recipe() {
  ...
  return (
    <section className="bg-white h-screen lg:grid flex flex-col grid-cols-12 overflow-hidden">
      <div className="lg:bg-base-mid bg-white shadow   col-span-3  lg:flex lg:flex-col sticky top-0 lg:h-full  lg:p-8 md:px-8 px-1  text-gray-700">
        ...
        <ul className="text-xl lg:flex flex-col gap-2 py-4 hidden">
          <li className="flex gap-2 items-center py-2 px-4 rounded-lg transition-all duration-300 ease-in-out hover:bg-orange-200 hover:translate-x-2">
            <GoHomeFill className="text-3xl" /> Home
          </li>
          <li className="flex gap-2 items-center py-2 px-4 rounded-lg transition-all duration-300 ease-in-out hover:bg-orange-200 hover:translate-x-2">
            <MdMenuBook className="text-3xl" /> Recipe
          </li>
          <li className="flex gap-2 items-center py-2 px-4 rounded-lg transition-all duration-300 ease-in-out hover:bg-orange-200 hover:translate-x-2">
            <BiLogoBlogger className="text-3xl" /> Blog
          </li>
          <li className="flex gap-2 items-center py-2 px-4 rounded-lg transition-all duration-300 ease-in-out hover:bg-orange-200 hover:translate-x-2">
            <RiContactsBook3Fill className="text-3xl" /> Contact Us
          </li>
          <li className="flex gap-2 items-center py-2 px-4 rounded-lg transition-all duration-300 ease-in-out hover:bg-orange-200 hover:translate-x-2">
            <TbInfoSquareRoundedFilled className="text-3xl" /> About
          </li>
        </ul>
      </div>
                  ...
                  <div className="md:grid grid-cols-12 ">
                    <div className=" col-span-7">
                      ...
                      <div className="flex flex-col md:pt-5 lg:flex-row lg:justify-between col-span-6">
                        {/* Grid Line  */}
                        <div className="grid grid-cols-3 gap-3 justify-between w-full py-2">
